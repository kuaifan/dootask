...
negative:
  ...
  - 仪表盘不再提供固定的「我的项目」卡片，新账号空状态只提供创建第一个项目入口
...
- **桌面端仪表盘**：新账号没有项目时，可从欢迎空状态点击「创建第一个项目」
- **桌面端右上「+」全局快捷**：「+ 添加项目」直接建项目（[[project.create.howto]]）
- **移动端**：底部 Tabbar → 「项目」Tab
- **桌面快捷键**：Cmd/Ctrl + P 唤起项目快搜
- **项目顶部「⋯」菜单**：底部分组依次为「归档项目」「移交项目」「删除项目」，按原有权限显示；分隔线位于「归档项目」上方。
...
- 部门负责人开启项目负责人视角后，显示「我的项目 / 负责人视角」分类，额外项目只读
...
- 部门负责人只读项目：[[org-department.deputy-view.howto]]
