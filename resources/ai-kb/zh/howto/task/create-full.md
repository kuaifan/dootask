...
## 取消已选人员
- 创建任务对话框展开「高级选项」后，右键负责人、协助人员或子任务负责人的已选头像，可立即取消该人的选择，无需打开人员选择弹窗或再次确认；仅修改当前创建表单。
- 左键点击头像仍打开人员选择弹窗，移动端沿用弹窗内取消选择的操作。指定可见人员和任务详情页不启用此右键操作。
- 保留原有联动：负责人变化后，如果协助人员为空且当前用户不在负责人中，会自动将当前用户加入协助人员。
